...
public class DBManager
{
    ...
    private static final String[][] DDL =
    {
        ...
        // v1
        {
            ...
            + "strength double not null default "+C.START_STRENGTH+", "
            + "land double not null default "+C.START_LAND+", "
            + "energy double not null default "+C.START_ENERGY+", "
            + "rage double not null default "+C.START_RAGE+", "
            // S = strength, L = land
